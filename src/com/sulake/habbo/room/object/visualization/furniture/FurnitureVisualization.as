package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1418:String = null;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1418 != null && var_1418.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2271,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_1896 != param1 || var_1898 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1897 != param1 || var_1895 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2271 = _loc3_.getNumber(RoomObjectVariableEnum.const_218);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_199));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1418 = _loc3_.getString(RoomObjectVariableEnum.const_327);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_287 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2264)
         {
