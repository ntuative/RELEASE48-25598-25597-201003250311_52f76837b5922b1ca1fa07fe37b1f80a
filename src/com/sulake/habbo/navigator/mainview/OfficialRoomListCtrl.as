package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1109:int = 65;
      
      private static const const_1110:int = -70;
      ...
      private function method_6(param1:IWindow, param2:Boolean) : void
      {
         var _loc5_:* = null;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_301,_loc2_.tag);
         }
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1110) : 0;
         param3.width = 274;
      ...
      private function onCell(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.method_6(param2,true);
         }
         else if(param1.type == WindowMouseEvent.const_30)
         {
            this.method_6(param2,false);
         }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1339)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1109) : int(const_1111);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_701 || param2.type == OfficialRoomEntryData.const_674))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
