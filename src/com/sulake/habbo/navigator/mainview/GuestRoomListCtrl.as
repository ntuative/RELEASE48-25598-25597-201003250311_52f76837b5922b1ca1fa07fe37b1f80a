package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1256 != null)
         {
            _loc2_ = var_1256.tags[0];
            var_1256.color = getBgColor(_loc2_);
         }
         var_1256 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_372 = IScrollbarWindow(var_19.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_2016 - _loc2_.stageX);
         var_2016 = _loc2_.stageX;
         var_2017 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_179,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_111,null,0);
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1290,true);
