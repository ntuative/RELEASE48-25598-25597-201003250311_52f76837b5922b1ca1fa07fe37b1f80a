package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1332);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1042[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_1282 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_1282.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1513.indexOf(param1) < 0)
         {
            var_1042[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_828 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_151));
         if(var_2044)
         {
      ...
      {
         var _loc4_:String = var_1042[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1282);
