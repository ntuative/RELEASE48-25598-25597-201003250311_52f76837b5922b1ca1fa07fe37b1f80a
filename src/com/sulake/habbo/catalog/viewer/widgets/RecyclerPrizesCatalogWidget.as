package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_879:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_719.length)
         {
            createLevelItem(var_719[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_879 = new PrizeViewer();
         var_719 = recycler.getPrizeTable();
         if(var_719 == null)
         {
            return;
         }
         ...
         var_1298 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_719[0].prizes.length > 0)
         {
            select(var_719[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1298) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_879.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
