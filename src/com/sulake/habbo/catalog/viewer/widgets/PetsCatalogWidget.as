package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_404 >= var_297.length)
         {
            return "";
         }
         var petColor:IPetColor = var_297[var_404] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_565[var_1471] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_404 < 0 || var_404 > var_297.length)
         {
            var_404 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         var_829 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_297 = [];
         var_565 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_829);
               if(_loc11_)
               {
                  var_565 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_565.length)
         {
            _loc12_ = var_565[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_829,_loc12_.id),getRaceLocalizationKey(var_829,_loc12_.id)));
            _loc6_++;
         }
         var_543.add(var_829,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_882,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_404 >= 0 && var_404 < var_297.length)
         {
            _loc7_ = var_297[var_404] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_565[var_1471] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_829,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_307,AvatarAction.const_641);
