      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_92:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_1018));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_656,RoomWidgetDimmerSavePresetMessage.const_713,RoomWidgetDimmerChangeStateMessage.CHANGE_STATE,RoomWidgetDimmerPreviewMessage.const_692];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_656:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_713:
               if(validateRights())
               {
            ...
            case RoomWidgetDimmerChangeStateMessage.CHANGE_STATE:
               ...
               break;
            case RoomWidgetDimmerPreviewMessage.const_692:
