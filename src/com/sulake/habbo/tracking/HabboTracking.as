package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_739:uint = 11;
       
      
      private var var_212:LatencyTracker = null;
      ...
      private var var_768:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_212 = new LatencyTracker();
         var_768 = new LagWarningLogger();
         var_1115 = new Array(const_739);
         var _loc4_:int = 0;
         while(_loc4_ < const_739)
         {
            var_1115[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1358,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1337,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_672,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_976,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_629:
               trackLoginStep(HabboLoginTrackingStep.const_1240,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_212 != null)
            {
               var_212.communication = _communication;
               var_212.connection = param1;
            }
            if(var_768 != null)
            {
               var_768.connection = param1;
            }
         }
      }
      ...
      {
         var_144 = IHabboConfigurationManager(param2);
         if(var_144)
         {
            Component(var_144).events.addEventListener(HabboConfigurationEvent.const_151,onConfigurationLoaded);
            if(var_212 != null)
            {
               var_212.configuration = var_144;
            }
            if(var_211 != null)
            {
               var_211.configuration = var_144;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_256.events.addEventListener(AdEvent.const_480,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_976,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_672,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_629,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_569,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_58,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_449,onHotelViewEvent);
      }
         ...
         if(!disposed)
         {
            ...
            if(var_162)
            {
               if(true)
               {
                  ...
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.const_291,onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_144)
         {
            if(var_768 != null)
            {
               var_768.configure(var_144);
            }
            Component(var_144).events.removeEventListener(HabboConfigurationEvent.const_151,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1007);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_1007,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_943 > -1 && _loc2_ < var_943)
         {
            ++var_1390;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1390);
         }
         if(var_943 > -1 && _loc2_ - var_943 > 15000)
         {
            ++var_1391;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1391);
         }
         var_943 = _loc2_;
         if(var_211 != null)
         {
      ...
      {
         if(var_144 != null && Boolean(var_144.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.const_291,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_144)
            {
               if(var_144.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_144.getKey("client.fatal.error.url");
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_569)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1338);
         }
         else if(param1.type == HabboHotelViewEvent.const_449)
         {
