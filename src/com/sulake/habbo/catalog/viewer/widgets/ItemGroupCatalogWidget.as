package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_555[var_958] as Array;
      ...
      {
         var _loc2_:Offer = var_555[var_958][var_1703];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_414 || _loc1_.pricingModel == Offer.const_382)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_74 || _loc3_.productType == ProductTypeEnum.const_81)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_957.indexOf(_loc5_) == -1)
                        {
                           var_957.push(_loc5_);
                           var_555.push(new Array());
                        }
                        _loc6_ = var_957.indexOf(_loc5_);
                        (var_555[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_555)
         {
            if(var_1703 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1703] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_958 = var_939.getGridItemIndex(param1.view);
