package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_709);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_281);
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_947);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_284)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_365)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_909)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_216)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_529);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1234;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_906;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_980;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1245);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_542.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_542.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_529);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_294);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_600);
         _loc1_.push(RoomWidgetFurniActionMessage.const_556);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_737);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_499);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1201);
         _loc1_.push(RoomWidgetPetCommandMessage.const_518);
         _loc1_.push(RoomWidgetPetCommandMessage.const_655);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_422)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_294:
            ...
            case RoomWidgetUserActionMessage.const_619:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_600:
            ...
            case RoomWidgetUserActionMessage.const_412:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_737:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_499:
