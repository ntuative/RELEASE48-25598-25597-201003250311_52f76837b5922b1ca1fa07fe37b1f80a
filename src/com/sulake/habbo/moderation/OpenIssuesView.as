package com.sulake.habbo.moderation
{
   ...
   public class OpenIssuesView implements IIssueBrowserView
   {
      ...
      private var var_1802:IssueListView;
      ...
      public function OpenIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         var_1802 = new IssueListView(param1,param2,_loc4_,"open_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = _issueManager.getBundles(IssueManager.const_975);
         var_1802.update(_loc1_);
      }
   }
}
