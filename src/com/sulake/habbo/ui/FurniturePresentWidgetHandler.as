package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1098:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_640,RoomWidgetPresentOpenMessage.const_607,RoomWidgetPresentOpenedMessage.const_1220];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_74:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_405,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_183)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_424,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1098)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_462:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_400,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_640:
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_607:
