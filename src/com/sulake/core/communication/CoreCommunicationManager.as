package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_378)
         {
            _loc10_;
            if(var_378[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_639[_loc3_];
      ...
      {
         var _loc3_:Array = var_639[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_639[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      {
         if(param1 == null || var_378 == null)
         {
            return null;
         }
         return var_378[param1] as IConnection;
      }
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_378)
         {
            _loc2_ = _loc5_;
            _loc5_;
