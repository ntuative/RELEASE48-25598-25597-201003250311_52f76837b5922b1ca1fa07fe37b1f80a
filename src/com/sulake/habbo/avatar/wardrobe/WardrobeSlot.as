package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_395 && var_1181)
         {
            _loc5_ = var_47.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_93);
            _loc5_.setDirection(AvatarSetType.const_37,parseInt(FigureData.const_537));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_395 = var_47.figureData.getFigureString();
               var_660 = var_47.gender;
               var_47.handler.saveWardrobeOutfit(var_1430,this);
               updateView();
               break;
            case "get_button":
               if(var_395)
               {
                  var_47.loadAvatarInEditor(var_395,var_660,var_47.clubMemberLevel);
               }
         }
      }
   }
