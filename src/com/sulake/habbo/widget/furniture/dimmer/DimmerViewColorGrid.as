package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_429.destroyGridItems();
         var_298 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1324) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_519.width;
            _loc3_.height = var_519.height;
            var_429.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_519.width,var_519.height,true,0);
               _loc4_.bitmap.copyPixels(var_519,var_519.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_729.width,var_729.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_729,var_729.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_429.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_429.numGridItems)
         {
            return;
         }
         select(var_429.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_298 != null)
         {
            _loc2_ = var_298.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_729 = BitmapData(_loc3_.content);
      }
