package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1156:int = 13421772;
      
      private static const const_777:int = 16777215;
      
      public static const const_1279:int = 10066329;
      
      private static const const_776:int = 13421772;
      ...
      private static const const_774:int = 10066329;
      
      private static const const_775:int = 10066329;
      ...
      private var var_1899:int = -1000;
      
      private var var_1026:uint = 16777215;
      ...
      private var var_1984:int = 255;
      
      private var var_1979:Boolean = false;
      
      private var var_1982:int = 255;
      
      private var var_1980:String = null;
      
      private const const_1637:int = 250;
      ...
      private var var_412:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_412 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_793);
         if(!var_74.initializeFromXML(new XML(_loc2_)))
         {
            return;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_935);
         var _loc7_:int = 0;
         while(_loc7_ < var_74.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1189)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_206,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_100.length)
            {
               _loc4_ = var_100[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_206 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_412.maskCount)
         {
            _loc6_ = var_412.getMaskType(_loc5_);
            _loc7_ = var_412.getMaskLocation(_loc5_);
            _loc8_ = var_412.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_100.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_206 || _loc3_.type == RoomPlane.const_184 && _loc8_ == RoomPlaneBitmapMaskData.const_229)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1493;
                        if(var_74.getPlaneType(_loc9_) == RoomPlaneData.const_137)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1357)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1084 || _loc9_.y != var_1987 || _loc9_.z != var_1981 || param1.scale != var_1986))
            {
               var_1084 = _loc9_.x;
               var_1987 = _loc9_.y;
               var_1981 = _loc9_.z;
         ...
         if(var_158 != _loc6_.getUpdateID())
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_874);
            if(_loc10_ != var_1980)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_587));
            if(_loc11_ != var_1026)
            {
               var_1026 = _loc11_;
               var_1982 = var_1026 & 255;
               var_1984 = var_1026 >> 8 & 255;
               var_1985 = var_1026 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1899 + const_1637 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1899 = _loc7_;
         if(var_158 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_570);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_646);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_546);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1983 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_969));
            var_158 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_411.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_411[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_184)
            {
               if(var_1983)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1982 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1984 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1985 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_100.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_206 && param2 != null)
               {
                  _loc5_.id = param2;
               }
