package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1630:uint = 4.291613146E9;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_788;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_788,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_575,var_76,var_959);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_788);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_559[var_182]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_558[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_575,var_76,var_959,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_143:
               ...
               if(var_1710 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_221)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1629)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1710 = _loc3_.text;
               break;
            case WindowMouseEvent.const_49:
               showSuggestions(false);
               if(var_1151)
               ...
               break;
            case WindowKeyboardEvent.const_715:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1417 = _loc1_.stuffTypes;
            var_559 = _loc1_.boxTypes;
            var_558 = _loc1_.ribbonTypes;
            var_788 = var_1417[0];
            var_182 = var_559[0];
            _ribbonIndex = var_558[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
