package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1367 != null && var_1367.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_105);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_911 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_911 += param1.height + const_1642;
            return fit(param1);
         }
         param1.offset(_offsetX,var_911);
         _offsetX += param1.width + const_1643;
         return true;
      }
