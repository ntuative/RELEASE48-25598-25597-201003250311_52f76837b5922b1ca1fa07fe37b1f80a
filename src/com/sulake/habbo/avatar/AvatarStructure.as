package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1761:PartOffsetData;
      
      private var var_807:AvatarActionManager;
      
      private var var_168:IAssetLibrary;
      
      private var var_971:IAssetLibrary;
      
      private var var_1382:Boolean = false;
      
      private var var_1760:AvatarRenderManager;
      
      private var var_394:FigureData;
      ...
      private var var_1429:AvatarStructureDownloadSet;
      
      private var var_658:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_168 = param2;
         var_971 = param3;
         var_394 = new FigureData();
         var_393 = new PartSetsData();
         _animationData = new AnimationData();
         var_1429 = new AvatarStructureDownloadSet();
         var_658 = new AnimationManager();
         var_659 = param4;
         var_1761 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_658.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_393.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1354[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_658.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_394.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_394.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_659 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_659)
         {
            case AvatarType.const_75:
               ...
               var_1429.add(new AvatarStructureDownload(var_168,_loc5_,var_394));
               break;
            case AvatarType.PET:
         }
         var_1429.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_658.getAnimation(param1);
      }
      ...
      {
         var_807 = new AvatarActionManager(var_168,var_659);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_971.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_971.getAssetByName("dance" + _loc1_).content as XML;
            var_658.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_971.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_971.getAssetByName("fx" + _loc1_).content as XML;
            var_658.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_394.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_394.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
