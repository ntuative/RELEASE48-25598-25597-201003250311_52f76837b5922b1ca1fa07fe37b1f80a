package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_191 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1945 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_191);
      ...
      public function dispose() : void
      {
         if(var_350 != null)
         {
            var_350.events.removeEventListener(BadgeImageReadyEvent.const_127,onBadgeImageReady);
            var_350 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_691,var_1945);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_1609.toString());
