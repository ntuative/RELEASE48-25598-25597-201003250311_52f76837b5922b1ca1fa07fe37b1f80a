package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_179 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_111 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
