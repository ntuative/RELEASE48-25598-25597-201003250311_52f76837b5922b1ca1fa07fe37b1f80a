package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1424:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_289 && _loc4_.state != FriendRequest.const_333)
            {
      ...
      {
         var_1549 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1550 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1550.procedure = onDismissAllButtonClick;
         var_1549.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1549,_loc1_);
         setEnabled(var_1550,_loc1_);
      }
