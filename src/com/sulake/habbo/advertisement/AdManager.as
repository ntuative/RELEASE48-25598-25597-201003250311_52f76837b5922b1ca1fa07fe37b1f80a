package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_775:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_480,0,0,_loc4_,var_1396,var_775,var_776));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1642 = int(_config.getKey("interstitial.interval","30000"));
         var_1640 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1129 = _loc2_.imageUrl;
         var_1396 = _loc2_.clickUrl;
         if(var_1129 != "" && var_1396 != "")
         {
            _loc3_ = var_1129;
            ...
            _loc4_ = new URLRequest(var_1129);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1130 = _loc2_.imageUrl;
         var_1641 = _loc2_.clickUrl;
         var_644 = getTimer();
         if(var_1130 != "")
         {
            _loc3_ = var_1130;
            ...
            if(var_214 == null)
            {
               var_214 = new Timer(var_1640,1);
               var_214.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_214.reset();
            ...
            var_214.start();
            _loc4_ = new URLRequest(var_1130);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_461,0,0,param1.bitmapData,var_1641));
            var_644 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_776 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         var _loc1_:int = getTimer() - var_644;
         if(_loc1_ > var_1642)
         {
            ++var_1398;
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_775 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
