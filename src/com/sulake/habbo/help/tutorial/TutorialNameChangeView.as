package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1572:uint = 13232628;
      
      private static var var_2203:uint = 11129827;
      ...
      private var var_276:IBorderWindow;
      
      private var var_914:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_435);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  _main.showView(TutorialUI.const_82);
                  break;
               case "button_usecurrent":
                  var_435 = _main.myName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_435);
         }
         if(var_276 == null)
         {
            var_276 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_276 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_276);
            var_276.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_276.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1598:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1597:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1597 || param1 == ChangeUserNameResultMessageEvent.var_1598)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_914 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_914.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1572;
