package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_508 == 0)
         {
            var_508 = _animationData.getStartFrame(var_1027,param1);
         }
         var_508 += 1;
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_838)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1027,var_508,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1027,_loc6_,_loc5_.activeSequenceOffset + 1,var_508,param1);
               }
