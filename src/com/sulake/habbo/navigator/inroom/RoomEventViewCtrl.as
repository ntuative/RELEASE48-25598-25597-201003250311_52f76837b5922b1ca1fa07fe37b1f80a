package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1753:IButtonWindow;
      ...
      private var var_1175:IButtonWindow;
      
      private var var_806:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_657.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_804.getText());
         addTag(_loc6_,var_805.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1426 = IWindowContainer(find("event_type_disabled_cont"));
            var_1754 = ITextWindow(find("event_type_disabled_text"));
            var_1428 = ITextWindow(find("create_caption"));
            var_1427 = ITextWindow(find("edit_caption"));
            var_1174 = IButtonWindow(find("create_button"));
            var_1176 = IButtonWindow(find("edit_button"));
            var_1753 = IButtonWindow(find("cancel_button"));
            var_1175 = IButtonWindow(find("end_button"));
            var_806 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1174,onCreateButtonClick);
            Util.setProcDirectly(var_1176,onEditButtonClick);
            Util.setProcDirectly(var_1175,onEndButtonClick);
            Util.setProcDirectly(var_1753,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_657 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_804 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_805 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_657.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_1426.visible = false;
         var_1174.visible = true;
         var_1176.visible = false;
         var_1175.visible = false;
         var_657.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_804.goBackToInitialState();
         var_805.goBackToInitialState();
         var_806.selection = 0;
