package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2181:MarketplaceItemStats;
      ...
      private var var_190:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1460,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1692 || param1.furniTypeId != var_1691)
         {
            return;
         }
         var_2181 = param1;
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_471)
            {
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_190)
         {
            var_190 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_190.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2179,var_2180,var_1915,var_2182);
      }
