         ...
         if(var_475 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_979,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_979,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_979,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_667[_loc6_ % 0] as IGraphicAsset;
