package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2063:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1518:ILogger;
      
      private var var_1289:String;
      
      private var var_2065:String;
      
      private const const_1416:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1317:
            case DisconnectReasonEvent.const_1153:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1140:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2064)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_713 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_713);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1289,var_2065));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1416,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2063);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1416,"/");
      ...
      {
         var_713 = _habboConfiguration.getKey("sso.ticket",null);
         var_1289 = _habboConfiguration.getKey("flash.client.url","");
         var_2065 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_174 == null)
         {
         ...
         if(var_713 != null)
         {
            var_63.mode = HabboConnectionType.const_479;
            var_63.initConnection(HabboConnectionType.const_261);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1518 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.addEventListener(Event.CONNECT,method_13);
      ...
      private function method_13(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_629);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2063 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_479:
               ...
               var_1051 = _loc4_;
               var_174.loadBannerImage(_loc7_ + "?token=" + var_1051,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_822:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1302:
               var_590 = generateRandomHexString(30);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_63.mode = HabboConnectionType.const_822;
            }
         }
         var_63.initConnection(HabboConnectionType.const_261);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_204);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_151,onConfigurationLoaded);
         }
      }
