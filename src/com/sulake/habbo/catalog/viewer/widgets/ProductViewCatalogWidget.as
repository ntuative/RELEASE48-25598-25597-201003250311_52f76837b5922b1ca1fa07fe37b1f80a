package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_411:
                  ...
                  if(var_585 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_585,var_1255,var_1299);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_307,AvatarAction.const_652);
                              _loc13_.appendAction(AvatarAction.const_504,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1498 = new Point(var_81.x,var_81.y);
