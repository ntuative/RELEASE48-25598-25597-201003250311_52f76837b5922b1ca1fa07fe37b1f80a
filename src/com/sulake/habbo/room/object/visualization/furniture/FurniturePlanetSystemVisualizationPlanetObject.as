package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1057:Number = 30;
      ...
      {
         var_666 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1251 = param3;
         var_1800 = param4 * 0 * 2 / 360;
         var_1447 = param5 * 0 * 2 / 360;
         _height = param6;
         var_813 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1251 * Math.cos(var_813 + var_1447);
         var _loc4_:Number = var_1251 * Math.sin(var_813 + var_1447);
         var _loc5_:Number = _height;
         var_666.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_666.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_666.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_666.add(param1);
         }
