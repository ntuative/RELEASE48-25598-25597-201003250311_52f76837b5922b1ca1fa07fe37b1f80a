package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1402:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_963,var_961,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_963,var_648,var_961,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1160 = param1.chatType;
         var_963 = param1.userId;
         var_648 = param1.userName;
         var_961 = param1.userCategory;
         _message = param1.text;
         var_1159 = param1.userX;
         var_183 = param1.userImage;
         var_962 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_962 != 0)
            {
               _loc30_ = uint(var_962 >> 16 & 255);
               _loc31_ = uint(var_962 >> 8 & 255);
               _loc32_ = uint(var_962 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1160 == RoomWidgetChatUpdateEvent.const_255)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_648);
            }
            else if(var_1160 == RoomWidgetChatUpdateEvent.const_274)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_648);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_340 + _loc20_.textWidth + const_485;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_963,var_961,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_963,var_961,_roomId,_roomCategory,param1);
      }
