package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_349.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_349)
         {
            var_349.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_349.reset();
            var_349 = null;
         }
         if(var_300)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_48 == null)
         {
            var_48 = IWindowContainer(_navigator.getXmlWindow(var_1268));
            var_48.visible = false;
         ...
         var_48.x = _loc2_.x + var_1933 + param1.width;
