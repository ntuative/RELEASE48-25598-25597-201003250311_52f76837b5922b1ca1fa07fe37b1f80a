package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.addEventListener(WindowEvent.const_262,onChildResized);
         _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_524,_window));
      }
      ...
      public function dispose() : void
      {
         if(_widget && false)
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_718));
         }
         _widget = null;
         if(false)
         {
