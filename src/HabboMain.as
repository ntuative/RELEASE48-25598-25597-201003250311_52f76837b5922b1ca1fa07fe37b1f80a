package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_29.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_863);
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_861,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            trackLoginStep(Habbo.const_25);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_861,error);
            Core.dispose();
         }
      }
