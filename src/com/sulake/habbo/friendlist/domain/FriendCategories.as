   ...
   public class FriendCategories
   {
      ...
      public function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc2_.updatedFriends)
         {
            ...
            var_426.messenger.setFollowingAllowed(_loc4_.id,_loc4_.followingAllowed && _loc4_.online);
            _loc6_ = isFriendOnline(_loc4_.id);
            if(_loc6_ && !_loc4_.online)
            {
               var_426.messenger.setOnlineStatus(_loc4_.id,_loc4_.online);
               var_426.notifications.addOfflineNotification(_loc4_.name,_loc4_.realName);
            }
            if(!_loc6_ && _loc4_.online)
            {
               var_426.messenger.setOnlineStatus(_loc4_.id,_loc4_.online);
               var_426.view.setNewMessageArrived();
               var_426.notifications.addOnlineNotification(_loc4_.name,_loc4_.figure,_loc4_.realName);
            }
