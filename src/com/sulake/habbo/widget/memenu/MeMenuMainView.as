      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_951);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1001));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_705);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_808));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_308);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_801));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_541);
               break;
            case "news":
               if(false && false)
               {
