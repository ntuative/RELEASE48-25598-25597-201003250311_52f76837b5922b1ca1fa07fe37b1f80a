package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1208.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1207.length)
         {
            _loc2_ = var_670.indexOf(var_1207[_loc4_]);
            if(_loc2_ > -1)
            {
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_295[var_670.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1844.elements("menu");
         var _loc5_:int = 0;
