package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_624,RoomWidgetEcotronBoxOpenMessage.const_679,RoomWidgetEcotronBoxOpenedMessage.const_1238];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_624:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_679:
