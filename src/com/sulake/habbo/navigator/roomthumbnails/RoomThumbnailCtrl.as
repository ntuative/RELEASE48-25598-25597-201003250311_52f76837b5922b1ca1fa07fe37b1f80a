package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1778:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1433,this._model.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1434,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1433 = IButtonWindow(find("top_tab"));
         var_1434 = IButtonWindow(find("obj_tab"));
         var_1778 = IWindowContainer(find("tile_grid"));
         var_1779 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1433,method_11);
         Util.setProcDirectly(var_1434,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1778;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1779;
