package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_687:String = "bg";
       
      
      private var var_1661:IContainerButtonWindow;
      
      private var var_1659:IContainerButtonWindow;
      ...
      {
         var_1659 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1662 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1661 = initButton("room_invite",onInviteButtonClick,param1);
         var_1660 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_687);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1659,isEnableMinimailButton(_loc1_));
         setEnabled(var_1662,isEnableHomeButton(_loc1_));
         setEnabled(var_1661,isEnableInviteButton(_loc1_));
         setEnabled(var_1660,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_687);
