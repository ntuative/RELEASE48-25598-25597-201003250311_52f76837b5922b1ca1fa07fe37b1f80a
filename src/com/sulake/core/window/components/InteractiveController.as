package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_445 = new Array();
         var_445[0] = MouseCursorType.const_328;
         var_445[1] = MouseCursorType.const_39;
         var_445[2] = MouseCursorType.const_328;
         var_445[3] = MouseCursorType.const_328;
         var_445[4] = MouseCursorType.const_39;
         var_445[5] = MouseCursorType.const_39;
         var_445[6] = MouseCursorType.const_328;
         if(var_327 == null)
         {
            var_327 = new Array();
            ...
            var_327[3] = WindowState.const_59;
            var_327[4] = WindowState.WINDOW_STATE_SELECTED;
            var_327[5] = WindowState.const_90;
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_948,param1.toolTipDelay != const_1392));
         return param2;
      }
      ...
      {
         var_937 = param1 == null ? const_738 : param1;
      }
