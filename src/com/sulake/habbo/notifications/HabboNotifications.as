package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1077:String = "pet_inventory";
      
      private static const const_1073:String = "pixelbalance";
      
      private static const const_1070:String = "credits";
      
      private static const const_1072:String = "inventory";
      
      private static const const_1076:String = "friendlist";
      
      private static const const_1071:String = "selectfurni";
      
      private static const const_1075:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_578:ParkBusDialogManager;
      
      private var var_577:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_410:HabboNotificationViewManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_838);
         }
         var _loc6_:Map = var_838["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1288);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_987)
         {
            return;
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1298);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1939)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_938);
            var_1939 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_577)
         {
            var_577.release(new IIDHabboToolbar());
            var_577 = null;
         }
         if(_windowManager)
         {
      ...
      {
         if(param1 != null && this.var_410 != null)
         {
            var_410.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_938,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_541.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         if(param2.type == WindowEvent.const_161 || param2.type == WindowEvent.const_582)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_410.isSpaceAvailable() && false)
         {
            var_410.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_578 == null)
         {
            var_578 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_578 != null)
         {
            var_578.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1010.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_541.createPetImage(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc14_.productType == CatalogPageMessageProductData.const_81)
               {
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_541.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      {
         var_577 = IHabboToolbar(param2);
         var_577.events.addEventListener(HabboToolbarEvent.const_85,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_350.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_931);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_931);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_85)
         {
            ...
            var_410 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_838["styles"],var_838["view"],var_577);
            ...
            registerUpdateReceiver(var_410,1);
            registerUpdateReceiver(this,2);
            var_350.events.addEventListener(BadgeImageReadyEvent.const_127,onBadgeImage);
            var_577.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
