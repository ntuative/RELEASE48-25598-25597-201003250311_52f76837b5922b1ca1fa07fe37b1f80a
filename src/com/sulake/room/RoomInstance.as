package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_240.getValue(_loc2_) != null)
         {
            _loc3_ = var_240.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_240 != null)
         {
            ...
            {
               _loc3_ = var_240.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_240.getValue(_loc2_) != null)
         {
            return var_240.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_240.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_240.getValue(String(param1)) as IRoomObjectManager;
      }
