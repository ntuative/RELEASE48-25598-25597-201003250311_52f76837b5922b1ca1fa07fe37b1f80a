package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_809:XML = null;
      
      private var var_31:int = 0;
      
      private var var_105:IRoomManagerListener;
      ...
      private var var_2359:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         _events.addEventListener(RoomContentLoadedEvent.const_384,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_396.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_396.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      public function removeObjectUpdateCategory(param1:int) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = var_96.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_96 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_96.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc2_:IRoomInstance = var_96.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_105 != null)
            {
               var_105.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_105 != null)
            {
               var_105.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_105 != null)
         {
            var_105.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_96.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         return var_96.getValue(param1) as IRoomInstance;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_42.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(false)
            {
               ...
               if(var_105 != null)
               {
                  var_105.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_31 = const_615;
            var_105.roomManagerInitialized(false);
         }
      }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = var_96.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = var_96.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_396.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_396.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 if(var_105 != null)
                                 {
                                    var_105.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         if(var_96.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         var_96.add(String(param1),_loc3_);
         var _loc4_:int = -1;
         while(_loc4_ >= 0)
         {
            _loc5_ = 0;
