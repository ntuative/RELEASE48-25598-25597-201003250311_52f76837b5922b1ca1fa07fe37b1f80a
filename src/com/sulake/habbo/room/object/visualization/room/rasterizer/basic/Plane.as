package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_646:PlaneVisualization = null;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_293.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_646 = var_293.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_646 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_293 != null)
         {
            ...
            {
               _loc1_ = var_293.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
