package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new FaqTextMessageEvent(method_12));
      ...
      private function method_12(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_21.tellUI(HabboHelpViewEnum.const_194,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_244,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_139);
      }
      ...
      {
         var_21.showUI(HabboHelpViewEnum.const_312);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_447);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_671);
         var_21.tellUI(HabboHelpViewEnum.const_671,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_365)
            {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_654);
      }
