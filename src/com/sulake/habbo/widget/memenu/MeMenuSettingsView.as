package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_691);
         }
         else
         {
      ...
      {
         var_672 = param1.volume;
         if(var_673 != null)
         {
            var_673.setValue(var_672);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1459 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = _widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1458 = (_loc5_.content as BitmapData).clone();
         }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_672 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1459);
               }
               break;
            case "sounds_on":
               if(var_672 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1461);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1460);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1459);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1458);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1461);
