package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1399:int = 0;
      ...
      private var var_777:AvatarVisualizationData = null;
      ...
      {
         var_777 = param1 as AvatarVisualizationData;
         createSprites(const_1030);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_398.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_571);
         ...
         var _loc14_:Number = _loc8_ - var_1134;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_315);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_287 != _loc3_.getUpdateID() || var_207 != param1.scale || var_158 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_454 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_454;
            ...
            if(var_395 != _loc7_)
            {
               for each(_loc49_ in var_398.getKeys())
               {
                  var_398.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_777.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_398.remove(_loc5_);
               var_398.add(_loc5_,_loc6_);
               var_395 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_288);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_237) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_237);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_724);
            _loc6_.appendAction(AvatarAction.const_576,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_419);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_407);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_307,AvatarAction.const_1271[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_890);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_913,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_995);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_936);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_918,_loc31_);
               }
            }
            ...
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_530);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_799,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_849);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_825,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_385);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_432) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_720);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_353);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_901);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_504,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1628);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_881))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_777.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_778.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_778)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_398 != null)
         {
            _loc1_ = var_398.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_398.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
