package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_548.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      public function method_9(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_723,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_290[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            param1.addEventListener(WindowDisposeEvent.const_723,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_291,WindowRedrawFlag.const_234);
            if(var_548.indexOf(param1) == -1)
            {
               var_548.push(param1);
            }
         }
