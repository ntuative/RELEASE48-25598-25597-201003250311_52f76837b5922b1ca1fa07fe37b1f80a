package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_782:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_461 = new Timer(100);
         var_461.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_41 = new Array();
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,104,"a"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,94,"b"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,36,"c"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,84,"d"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,80,"e"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,80,"f"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_138,80,"g"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_138,74,"h"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,416,"i"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,320,"j"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,448,"k"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,352,"l"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,384,"m"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_79,372,"n"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_138,416,"o"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_138,352,"p"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_138,304,"q"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_138,336,"r"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_149,0,"s"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_149,0,"t"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_149,0,"u"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_149,0,"v"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_149,0,"w"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_149,0,"x"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_955 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_149)
         {
            _loc8_ = "vip_icon";
         }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_955.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1675 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_461)
         {
            var_461.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_461.reset();
            var_461 = null;
         }
      }
      ...
      {
         var_955.goBackToInitialState();
         var_955.input.textBackgroundColor = 4294967295;
         var_782 = var_41[0];
         if(var_1675 != _navigator.data.hcMember)
         {
      ...
      {
         var _loc1_:Boolean = var_955.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_782.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1144 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1144 = true;
            _loc3_.y = 1;
