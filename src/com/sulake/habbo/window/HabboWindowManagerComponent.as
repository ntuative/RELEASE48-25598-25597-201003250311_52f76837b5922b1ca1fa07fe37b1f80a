package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1226:ProfilerAgentTask;
      
      private var var_1224:IEventDispatcher;
      
      private var var_2364:uint = 0;
      
      private var var_1225:ProfilerAgentTask;
      
      private var var_1227:ProfilerOutput;
      
      private var var_679:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1224 = Component(param1).events;
         var_405 = new Array();
      ...
      {
         return var_227[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_227[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_679 = new WindowRenderer(var_678);
         var_227 = new Array(const_342);
         var _loc5_:int = 0;
         while(_loc5_ < const_342)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_679,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_227[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_227[const_1065];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_328,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1236,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_227[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_227.pop()).dispose();
            }
            var_227 = null;
            while(false)
            {
      ...
      {
         return var_227[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_405[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_405[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1227 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1227 = new ProfilerOutput(_loc3_,this,var_679);
               var_1226 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1226);
               var_1225 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1225);
               var_997 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1224.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_342 - 1;
            while(_loc2_ >= 0)
            {
               var_227[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_997)
         ...
         var_1224.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_342)
         {
            var_227[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_997)
         {
         ...
         if(WindowContext.var_1370.length > 0)
         {
            WindowContext.var_1370.flush();
         }
         var_1224.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1198,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1356,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1200,new Date().getTime().toString());
