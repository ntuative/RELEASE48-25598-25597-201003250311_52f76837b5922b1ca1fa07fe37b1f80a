package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = var_261.getValue(_loc2_.groupId);
         var_1094[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(var_261.getValue(_loc4_) != null)
            {
               var_261.remove(_loc4_);
            }
            var_261.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return var_261.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = var_1094[param1];
         if(_loc2_ == null)
         {
