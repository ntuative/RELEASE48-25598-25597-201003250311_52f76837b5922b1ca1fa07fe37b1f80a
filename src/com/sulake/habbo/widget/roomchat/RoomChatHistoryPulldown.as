package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_35 = param3;
         var_1655 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1407 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1658 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1406 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1408 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1653 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1656 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_67 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_39,HabboWindowParam.const_66,new Rectangle(0,0,param3.width,param3.height - const_70),null,0,0) as IBitmapWrapperWindow;
         var_35.addChild(var_67);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_55,HabboWindowStyle.const_39,HabboWindowParam.const_41,new Rectangle(0,0 - const_70,param3.width,const_70),null,0) as IWindowContainer;
         var_35.addChild(_window);
         var_95 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_392,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_70),null,0) as IRegionWindow;
         if(var_95 != null)
         {
            var_95.background = true;
            var_95.mouseTreshold = 0;
            var_95.addEventListener(WindowMouseEvent.const_49,onPulldownMouseDown);
      ...
      public function update(param1:uint) : void
      {
         switch(state)
         {
            case const_430:
               ...
               break;
            case const_792:
               var_67.blend = 0 - param1 / const_747;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_95 != null)
         {
            var_95.x = 0;
            var_95.y = 0 - const_70;
            var_95.width = 0 - var_1654;
         }
         if(var_67 != null)
         {
            var_67.rectangle = var_35.rectangle;
            var_67.height = 0 - const_70;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1657 == _window.width)
         {
            return;
         }
         var_1657 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1655.clone(),_loc7_);
