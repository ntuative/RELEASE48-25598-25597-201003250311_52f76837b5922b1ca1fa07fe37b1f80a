package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_101:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_735,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_573];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_573:
      ...
      {
         return [RoomSessionDoorbellEvent.const_101,RoomSessionDoorbellEvent.const_106,RoomSessionDoorbellEvent.const_53];
      }
