package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1086 + var_1086 / -var_2348 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_923 - var_923 / var_440 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_440).toString().length - 1);
         var_440 = Math.ceil(var_440 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_440.toString();
         _loc3_.draw(_loc6_);
         var_1086 = param1 - _loc6_.textWidth - 2;
         var_923 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_923);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_923 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1086 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1086,(param2 - var_923) / 2));
         return _loc3_;
      }
