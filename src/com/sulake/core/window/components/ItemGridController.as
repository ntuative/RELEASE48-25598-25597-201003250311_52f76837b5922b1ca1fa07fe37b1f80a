package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      {
         var _loc2_:IItemListWindow = var_14.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_326,WindowStyle.const_317,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),listEventProc,null,numListItems,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IItemListWindow;
