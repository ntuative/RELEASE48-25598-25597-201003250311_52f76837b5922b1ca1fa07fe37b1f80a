package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_750:String = "selection_arrow";
      
      private static const const_751:String = "tile_cursor";
      ...
      private static const const_1034:String = const_339;
      ...
      public static const const_710:String = "RCL_LOADER_READY";
      ...
      private var var_953:IEventDispatcher = null;
      
      private var var_1141:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_456 = [];
         var_458 = [];
         var_1668 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1670 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_380 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_456.indexOf(_loc4_) == -1)
                     {
                        var_456.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_29:
                     if(var_458.indexOf(_loc4_) == -1)
                     {
                        var_458.push(_loc4_);
                     }
                     break;
      ...
      {
         if(var_165 != null && var_165.hasWorldType(const_277 + param1))
         {
            return var_165.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_457.add(_loc10_,_loc11_);
                              if(var_456.indexOf(_loc14_) < 0)
                              {
                                 var_456.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_458.indexOf(_loc14_) < 0)
                              {
                                 var_458.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_330 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_330.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_550.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_339,const_484,ROOM_CONTENT,const_751,const_750];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1668.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      {
         var _loc2_:String = var_457.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_456.indexOf(param1) >= 0)
         {
            return const_339;
         }
         if(var_458.indexOf(param1) >= 0)
         {
            return const_484;
         }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_549.getValue(param1);
         }
         return "";
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1667)
         {
            ...
            if(var_953 != null)
            {
               var_953.dispatchEvent(new Event(const_710));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_165 != null)
         {
            return var_165.getWorldHeightScale(const_277 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_953 = param1;
            var_1664 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1665 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1669 = param2.getKey("public.room.dynamic.download.url","");
            var_1666 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_749;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_330.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_381 != null)
         {
            var_381.remove(param2);
            var_381.add(param2,param1);
         }
      }
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_396.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1141.getValue(param1) != null)
         {
            var_165 = var_1141.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_165 != null)
         {
            return var_165.getWorldScale(const_277 + param1);
         }
         return 32;
      }
