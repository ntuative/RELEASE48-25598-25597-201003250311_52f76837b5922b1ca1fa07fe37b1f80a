package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_778)
            {
               if(var_701 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_701.errorID,var_701);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_701);
               }
            }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1094) : uint(const_494);
      }
