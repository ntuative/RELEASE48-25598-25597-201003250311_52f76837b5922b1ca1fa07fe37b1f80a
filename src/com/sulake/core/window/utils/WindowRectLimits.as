package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_420:int = 2147483647;
      ...
      {
         return var_423 == int.MIN_VALUE && var_420 == int.MAX_VALUE && var_421 == int.MIN_VALUE && var_422 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_420 = param1;
         if(var_420 < int.MAX_VALUE && true && _target.width > var_420)
         {
