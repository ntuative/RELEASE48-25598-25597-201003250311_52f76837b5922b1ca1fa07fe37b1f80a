package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1616:String = "energy";
      
      private var var_1123:Map;
      
      private const const_1619:String = "nutrition";
      ...
      private const const_1620:int = 158;
      
      private const const_1617:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_244:PetCommandTool;
      
      private const const_1615:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_225 != null)
         {
            var_97 = var_225.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_97 == null || var_225 == null || var_59 == null)
         {
            return;
         }
         ...
         var_225.height = NaN;
         _window.width = Math.max(var_225.width,var_59.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1123.getValue(var_671) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1616,param1.energy,param1.energyMax);
         updateStateElement(const_1619,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_671 = param1.id;
         var_1123.remove(param1.id);
         var_1123.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_406,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1620,const_1617,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1615);
