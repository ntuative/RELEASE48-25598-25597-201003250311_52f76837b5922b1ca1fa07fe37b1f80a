package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2336:Rectangle = new Rectangle();
      ...
      protected var var_539:String = "none";
      ...
      {
         return new Rectangle(var_631 * maxScrollH,var_372 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_761)
         {
            context.removeLocalizationListener(var_321,this);
         }
         if(var_66 != null)
         {
            var_66.dispose();
      ...
      {
         var_631 = param1;
         _field.scrollH = var_631 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_321 = param1;
         if(var_321.charAt(0) == "$" && var_321.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_321.slice(2,var_321.indexOf("}")),this);
            var_761 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_371,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_371,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_520,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_520,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_539,PropertyStruct.STRING,var_539 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_520,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_539 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_539 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_539 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_539 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
