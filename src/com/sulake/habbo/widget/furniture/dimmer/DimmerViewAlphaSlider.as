package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_91 && param1.type != WindowMouseEvent.const_408)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1472 * (var_993 - var_677)) + var_677;
      }
   }
}
