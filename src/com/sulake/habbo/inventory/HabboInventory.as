package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_876:IRoomSession;
      ...
      private const const_1640:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_439,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_104:
               var_876 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_439:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_725));
      }
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_142));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_921));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1640);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_875.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_875.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_44.getValue(InventoryCategory.const_468) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_266));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_439,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_468,_loc3_);
         ...
         var_44.add(InventoryCategory.const_142,_loc10_);
