   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_860 = _window.findChildByName("effect_hilite");
            var_860.visible = false;
         }
         var_861 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_862 = _window.findChildByName("loader_bar");
         if(var_862 != null)
         {
            var_420 = var_862.width;
            var_178.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_861 != null)
         {
            var_861.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_861.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
