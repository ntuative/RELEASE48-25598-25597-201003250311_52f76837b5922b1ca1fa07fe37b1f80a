package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1112:Number = 4285716709;
      ...
      private var var_1555:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1555 == 4294967295)
            {
               var_1555 = _loc1_.color;
            }
            _loc1_.color = const_1112;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1554) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1556) as IItemListWindow;
         if(var_49 == null)
         {
