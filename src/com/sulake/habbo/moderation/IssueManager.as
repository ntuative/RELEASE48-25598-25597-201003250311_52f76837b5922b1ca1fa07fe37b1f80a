package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_975:String = "issue_bundle_open";
      
      public static const const_540:String = "issue_bundle_my";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_121 = new Map();
         var_816 = new Map();
         var_563 = new IssueBrowser(this,var_55.windowManager,var_55.assets);
         var_668 = [];
         var_817 = [];
         var_980 = new Map();
      }
         ...
         for each(_loc4_ in var_121)
         {
            switch(param1)
            {
               case const_975:
                  ...
                  break;
               case const_540:
                  if(_loc4_.state == IssueMessageData.const_474 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      {
         var _loc2_:IssueBundle = var_121.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_668 = var_668.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_816.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_121.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_121.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_816.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1148)
         {
            var_153.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_121)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_816.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_816.add(param1.issueId,_loc2_);
            var_121.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_668.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_146)
         {
            _loc5_ = getBundles(const_540);
            _loc6_ = false;
            ...
            _loc8_ = var_817.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_474 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc3_:IssueBundle = var_121.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_121.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_55.soundManager.playSound(HabboSoundTypesEnum.const_839);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_816.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_121.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_121.getValues();
         var _loc4_:int = var_55.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_474 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
