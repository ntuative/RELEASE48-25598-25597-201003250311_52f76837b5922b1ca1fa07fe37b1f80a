package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1234 && param1.type == RoomEngineObjectEvent.const_219)
         {
            var_47.showView();
            var_1234 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1234 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_35,RoomObjectTypeEnum.const_284,_loc3_.figure);
            var_47.closeView();
            return;
         }
