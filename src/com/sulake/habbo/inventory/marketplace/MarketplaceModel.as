package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1414,var_1413);
         }
      }
      ...
      {
         if(param1 != var_1692 || param2 != var_1691)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1690);
      }
      ...
      {
         if(var_47 != null && false && var_217 != null)
         {
            var_47.furniModel.removeLockFrom(var_217.id);
            var_217 = null;
         }
      }
