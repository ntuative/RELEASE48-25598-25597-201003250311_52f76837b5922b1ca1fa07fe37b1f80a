package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1260:String = "HabboRoomWidgetLib_clothes_white";
      ...
      private var _floorType:String = "HabboRoomWidgetLib_clothes_white";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_144.floors.pattern)
                     {
                     ...
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_144.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_144.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_269 != null && var_267 != null)
         {
            setRoomImage(var_269,var_267);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_144.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_233 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_233];
                  if(_loc9_ != null)
                  {
                     var_1260 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_144.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
         ...
         for each(_loc1_ in var_144.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_183:
               ...
               var_724 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_144.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_724 = _loc8_.children().length();
                  }
               }
            ...
            case const_182:
               ...
               for each(_loc9_ in var_144.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_725 = _loc9_.children().length();
                  }
               }
            ...
            case const_184:
               ...
               var_726 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_144.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_726 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1260,var_1258,64,this,"window_romantic_wide");
