package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_466 = var_246.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_466 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_246 != null)
         {
            ...
            {
               _loc1_ = var_246.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_246.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_246.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
