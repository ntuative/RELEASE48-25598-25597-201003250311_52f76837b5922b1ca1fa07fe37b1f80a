package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2184:Number = -10000000;
      
      private var var_2186:Number = -10000000;
      ...
      private var var_1081:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1079 == 0)
         {
            checkMouseHits(var_1080.x,var_1080.y,MouseEvent.MOUSE_MOVE);
         }
         var_1079 = 0;
         ++var_1567;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_51.graphics.beginFill(var_2347);
      ...
      {
         var _loc11_:Number = param1 - var_741 / 2;
         var _loc12_:Number = param2 - var_743 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_741 != var_2187 || var_743 != var_2188)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         if(_loc6_ < var_433.length)
         {
            var_433.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_433[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_742.push(_loc12_ - _loc2_);
         if(var_742.length == const_786)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_786)
            {
               _loc13_ += var_742[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_524 != null)
         {
            ...
            {
               cleanSprite(var_524[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_524 = [];
         }
         ...
         while(_loc1_ < var_320.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1081 != null)
                  {
                     var_1081.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1567,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_238.method_1(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_523.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_523.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2184 || param2 != var_2186)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_523.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_523.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_524.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_238.method_1(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_238.method_1(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         var _loc6_:RoomObjectCacheItem = var_525.getObjectCache(param2);
         ...
         _loc12_ += int(var_741 / 2);
         _loc13_ += int(var_743 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_741 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_743))
                  {
