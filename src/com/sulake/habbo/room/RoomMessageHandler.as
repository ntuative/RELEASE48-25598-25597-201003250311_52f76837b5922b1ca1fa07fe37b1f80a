package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_956:int = -1000000000;
      
      private var var_1146:Boolean = true;
      ...
      private function onItemUpdate(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            var_9.method_7(_loc4_,_loc5_,_loc7_.id,_loc8_,_loc9_,_loc7_.state,_loc7_.data);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_727);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_988:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_945:
                     _loc10_ = "std";
               }
