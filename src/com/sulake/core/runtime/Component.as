package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected var var_397:uint = 0;
      
      protected var var_14:IContext = null;
      
      protected var var_1633:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_941 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_941);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1111 & const_875)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_397 + "]";
      }
   }
}
