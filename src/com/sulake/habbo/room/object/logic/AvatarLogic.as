         ...
         if(object != null)
         {
            ...
            if(object.getType() == RoomObjectVisualizationEnum.const_107 || object.getType() == RoomObjectVisualizationEnum.BOT)
            {
               if(param1 is RoomObjectAvatarUpdateMessage)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_288,_loc5_.dirHead);
                  }
               }
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_315,new Date().valueOf());
                  }
                  else
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_315,-1);
                  }
               }
               if(param1 is RoomObjectAvatarTypingUpdateMessage)
               {
                  _loc7_ = param1 as RoomObjectAvatarTypingUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_881,Number(_loc7_.isTyping));
               }
               ...
               if(param1 is RoomObjectAvatarDanceUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_890,_loc11_.danceStyle);
               }
               ...
               if(param1 is RoomObjectAvatarEffectUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_901,_loc13_.effect);
               }
               ...
               if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_849,_loc15_.itemType);
               }
               if(param1 is RoomObjectAvatarGestureUpdateMessage)
               {
                  _loc16_ = param1 as RoomObjectAvatarGestureUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_419,_loc16_.gesture);
                  _loc4_.setNumber(RoomObjectVariableEnum.const_407,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  _loc17_ = param1 as RoomObjectAvatarChatUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_571,_loc17_.numberOfWords);
               ...
               if(param1 is RoomObjectAvatarSignUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_995,_loc18_.signType);
                  _loc4_.setNumber(RoomObjectVariableEnum.const_936,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  _loc19_ = param1 as RoomObjectAvatarPostureUpdateMessage;
                  _loc4_.setString(RoomObjectVariableEnum.const_237,_loc19_.postureType);
                  _loc4_.setString(RoomObjectVariableEnum.const_724,_loc19_.parameter);
               }
               if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
               {
                  _loc20_ = param1 as RoomObjectAvatarFlatControlUpdateMessage;
                  _loc4_.setString(RoomObjectVariableEnum.const_529,_loc20_.rawData);
                  _loc4_.setNumber(RoomObjectVariableEnum.const_1232,Number(_loc20_.isAdmin));
               }
