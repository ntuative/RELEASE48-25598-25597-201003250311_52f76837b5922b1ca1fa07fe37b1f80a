package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_936:ITabSelectorWindow;
      
      private var var_828:Boolean = false;
      
      protected var var_1603:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1603 == null)
         {
            var_1603 = findChildByTag(TabContextController.const_1093) as IWindowContainer;
         }
         return var_1603;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_936 == null)
         {
            var_936 = findChildByTag(TabContextController.const_1092) as ITabSelectorWindow;
            if(var_936 != null)
            {
               var_936.procedure = selectorEventProc;
            }
         }
         return var_936;
      }
