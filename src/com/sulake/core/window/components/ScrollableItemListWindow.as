package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_835:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_346)
         {
            ...
            if(var_346)
            {
               var_346.addEventListener(WindowEvent.const_275,scrollBarEventProc);
               var_346.addEventListener(WindowEvent.const_192,scrollBarEventProc);
            }
         }
         return var_346;
      }
      ...
      override public function dispose() : void
      {
         if(var_346)
         {
            var_346.removeEventListener(WindowEvent.const_275,scrollBarEventProc);
            var_346.removeEventListener(WindowEvent.const_192,scrollBarEventProc);
            var_346 = null;
         }
         if(var_835)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_835)
         {
            var_835 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_835;
      }
