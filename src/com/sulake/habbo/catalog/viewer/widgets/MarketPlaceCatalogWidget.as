package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_769:MarketPlaceOfferData;
      
      private const const_1397:int = 1;
      
      private const const_1613:int = 40;
      
      private var var_453:IWindowContainer;
      
      private const const_1398:int = 2;
      ...
      private function updateList() : void
      {
         ...
         if(!var_453)
         {
            ...
            var_453 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_453)
         {
            return;
         ...
         updateStatusDisplay(const_1398,_loc2_.length);
         if(!var_376)
         {
            var_376 = new Timer(25);
            var_376.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_770 = 0;
         populateList();
         var_376.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_453 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_453.clone() as IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(var_376)
         {
            var_376.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_376 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_770 >= var_543.length)
            {
               return true;
            }
            addListItem(var_543.getWithIndex(var_770));
            ++var_770;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_769.offerId);
            }
            return;
         }
