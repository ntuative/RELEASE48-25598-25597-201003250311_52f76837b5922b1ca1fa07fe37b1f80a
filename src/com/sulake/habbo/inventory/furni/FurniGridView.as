package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         return var_477.removeGridItemAt(param1);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_49)
         {
            ...
            _model.toggleItemSelection(_category,var_477.getGridItemIndex(param1.window));
            var_338 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_30 && var_338 != null && var_338 == param2 && true)
         {
