package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1308:uint = 0;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_442 = _loc13_.blend;
            var_534 = _loc13_.treshold;
            if(var_626 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_533 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
         ...
         if(param7 != null)
         {
            ...
            if(var_16)
            {
               var_14.invalidate(this,var_7,WindowRedrawFlag.const_71);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_122,WindowParam.const_148);
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_141);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_626 = param1;
         var_533 = !!var_626 ? uint(var_533 | var_1371) : uint(var_533 & 16777215);
      ...
      {
         var_534 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1160:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1342:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_78 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_355,this,null));
         }
      }
      ...
      {
         var_442 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_837);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1062 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_534);
      }
      
      public function set color(param1:uint) : void
      {
         var_1371 = param1 & 4278190080;
         var_533 = !!var_626 ? uint(param1) : uint(param1 & 16777215);
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_71);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_633))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1016;
                  if(testParamFlag(WindowParam.const_283))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_227))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_170:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_397,this,null));
                     if(testParamFlag(WindowParam.const_162,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_153,WindowParam.const_141))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_423:
                  var_14.invalidate(this,var_7.union(var_54),WindowRedrawFlag.const_456);
                  if(param1 == this)
                  {
               ...
               case WindowNotifyEvent.const_304:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_509,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_209,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_409:
                  var_14.invalidate(this,var_7,WindowRedrawFlag.const_898);
                  break;
               case WindowNotifyEvent.const_355:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_359:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_14.invalidate(this,var_7,WindowRedrawFlag.const_456);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_209:
                  ...
                  break;
               case WindowNotifyEvent.const_397:
                  var_8.getRegionProperties(null,var_314);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_302:
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_534);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_699,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1062 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_354)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_827,this,null,true);
               update(this,_loc10_);
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1207,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_14.invalidate(this,param1,WindowRedrawFlag.const_71);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1243,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            else
            {
               ...
               var_314.width = 0;
               var_314.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_887,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_359,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_14,var_7,null,var_630,properties,var_625.concat(),_id) as WindowController;
         ...
         _loc2_.var_354 = var_354;
         _loc2_.var_442 = var_442;
         _loc2_._param = _param;
         _loc2_.var_31 = var_31;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_321;
         _loc2_.background = var_626;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_408;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_31 == WindowState.const_404)
         {
            return true;
         }
         var_31 = WindowState.const_404;
