package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_300:int = 100;
      ...
      {
         return Math.ceil(this.var_221.length / const_300);
      }
      ...
      {
         if(this.var_808 >= this.getPageCount())
         {
            this.var_808 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_808 + 1) * const_300,this.var_221.length);
      }
