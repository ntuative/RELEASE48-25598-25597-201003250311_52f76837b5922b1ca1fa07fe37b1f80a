package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_771:String = "margin_top";
      
      private static const const_1081:String = "_HEADER";
      ...
      private var var_1240:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_771,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_768,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_770,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_201);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_220);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_201,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_201,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1240 == null)
         {
            var_1240 = findChildByTag(const_1081) as IHeaderWindow;
            if(!var_1240)
            {
      ...
      {
         return content != null && var_1382 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1079) as IWindowContainer;
            if(!var_19)
            {
