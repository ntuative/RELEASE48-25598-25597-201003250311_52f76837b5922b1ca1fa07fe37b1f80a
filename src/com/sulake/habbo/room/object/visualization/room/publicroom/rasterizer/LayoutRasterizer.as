package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_987:Point = null;
      
      private var var_480:Array;
      
      private var var_985:LayoutRasterizerData = null;
      ...
      private var var_773:IGraphicAssetCollection;
      ...
      {
         var_482 = true;
         var _loc3_:int = var_345.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_345.push(param1);
            var_481.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_986 = param1;
         var _loc3_:LayoutRasterizerData = var_41.getValue(var_676);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1218 = RoomObjectVariableEnum.const_996;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1218 = RoomObjectVariableEnum.const_830;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_986 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_986 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_986 + _adBgIndex);
            _loc5_ = param1.getSprite(var_986 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1218);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_476;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1866);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_676)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_985 = var_41.getValue(var_676);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_41.getValue(var_676);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_985.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_773.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_987.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_987.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_345.indexOf(_loc10_) >= 0 && var_482)
            {
               param1 = var_345.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_773.getAsset(var_481[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_480[param1];
               }
               var_345.splice(param1,1);
