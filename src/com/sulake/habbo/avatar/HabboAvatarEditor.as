package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_763:AvatarEditorHandler;
      ...
      private const const_1026:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_635.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_160)
         {
            ...
            var_451["null"] = new FigureData(this);
            var_451["null"] = new FigureData(this);
            _loc1_ = var_451["null"];
            _loc2_ = var_451["null"];
            ...
            var_87 = new Map();
            var_375 = new Map();
            var_87.add(AvatarEditorFigureCategory.const_853,new BodyModel(this));
            var_87.add(AvatarEditorFigureCategory.const_47,new HeadModel(this));
            var_87.add(AvatarEditorFigureCategory.const_296,new TorsoModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1259,new LegsModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1263,new HotLooksModel(this));
            var_375.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_375.add(AvatarEditorSideCategory.const_475,new ClubPromoModel(this));
            var_160 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_942 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1387;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_942 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1026)
                  {
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1306)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_942 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_375.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_763 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_635.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_375.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_853);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_635 = var_541.getFigureData(AvatarType.const_75);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_541 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_942 = param3;
         var _loc4_:FigureData = var_451[param2];
         if(_loc4_ == null)
         {
            return;
         }
