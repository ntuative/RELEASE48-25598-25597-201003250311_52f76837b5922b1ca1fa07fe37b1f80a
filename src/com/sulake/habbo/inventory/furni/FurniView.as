package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_720:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_526 = new Map();
         var_526.add(FurniModel.const_42,new FurniGridView(_model,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         var_526.add(FurniModel.const_43,new FurniGridView(_model,FurniModel.const_43,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_526.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_526.getValue(var_527);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_526.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_527);
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_720 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_526.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
