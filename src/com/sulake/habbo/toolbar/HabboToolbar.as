package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_915,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_180,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_594,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_833,onHideWindowEvent);
         var_31 = true;
