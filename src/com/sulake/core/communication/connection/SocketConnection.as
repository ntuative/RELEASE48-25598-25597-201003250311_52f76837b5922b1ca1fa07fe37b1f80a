package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1340:int = 10000;
      ...
      private var var_751:IEncryption;
      
      private var var_752:int;
      
      private var var_364:ByteArray;
      ...
      private var var_365:IConnectionStateListener;
      
      private var var_616:IProtocol;
      
      private var var_922:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_307 = param2;
         var_364 = new ByteArray();
         var_922 = new MessageClassManager();
         var_77 = new Socket();
         var_363 = new Timer(const_1340,1);
      ...
      {
         var_363.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_752));
      ...
      {
         var_363.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_752));
      ...
      private function onConnect(param1:Event) : void
      {
         var_363.stop();
         var_1356 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_752));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_922.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_365)
         {
            var_365.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_751 != null)
         {
            _loc3_ = var_751.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_365)
         {
            var_365.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_364.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_922.registerMessages(param1);
      }
      ...
      {
         var_363.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_752));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_616.getMessages(var_364,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_365)
            {
               var_365.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_922.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_307.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_307.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_364,_loc2_);
            var_364 = _loc18_;
         }
      }
      ...
      {
         var_363.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_752));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_363.stop();
         var_1356 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_752));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_751 + "\n");
      }
   }
}
