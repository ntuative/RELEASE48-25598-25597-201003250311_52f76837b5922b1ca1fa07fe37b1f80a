package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1019:ICheckBoxWindow;
      ...
      private var var_698:ICheckBoxWindow;
      
      private var var_50:IFrameWindow;
      
      private var var_1018:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_568,_data.flatId),var_50,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_419);
         if(param1.flatId != var_419)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_419);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_698.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1241,_loc2_,var_417.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1019.isSelected,var_1018.isSelected,var_698.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_698 = ICheckBoxWindow(var_50.findChildByName("kick_check"));
         var_1019 = ICheckBoxWindow(var_50.findChildByName("lock_check"));
         var_1018 = ICheckBoxWindow(var_50.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_419));
         Logger.log("BEGINNING TO SHOW: " + var_419);
      }
   }
}
