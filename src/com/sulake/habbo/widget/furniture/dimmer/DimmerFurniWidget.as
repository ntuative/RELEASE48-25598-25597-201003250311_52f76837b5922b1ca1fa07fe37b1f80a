package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1046:Array = new Array(int(76.5),int(76.5));
      
      private static const const_1047:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_702,onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_1018,onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         if(!validateBrightness(var_970,var_969))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(_color,var_970,var_969 == 2);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var_800 = param1.selectedPresetId - 1;
         _presets = new Array();
         var _loc2_:int = 0;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(_color,var_970,var_969 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_702,onPresets);
      }
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:DimmerFurniWidgetPresetItem = _presets[var_800] as DimmerFurniWidgetPresetItem;
