package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1480:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_575 != null)
         {
            if(var_575.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_575.window);
            var_575.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1480);
         var_575 = _loc5_;
      ...
      {
         return var_575.dispatchWidgetEvent(param1);
      }
