package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_752:int = 50;
      
      private static const const_1036:Number = 25;
      
      private static const const_1035:int = 50;
      ...
      public function removeItem(param1:String) : void
      {
         if(var_292.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_292.splice(var_292.indexOf(param1),1);
            }
         }
      }
      ...
      {
         return var_460[var_459.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_292[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_752 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_752 || param1.desktop.height - param1.y < const_1035;
      }
