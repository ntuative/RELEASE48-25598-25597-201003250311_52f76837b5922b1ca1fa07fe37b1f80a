package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_1589:int = 0;
      ...
      public function dispose() : void
      {
         ...
         if(var_98 != null)
         {
            ...
            {
               _loc2_ = var_98.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc5_:AnimationLayerData = var_98.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc3_:AnimationLayerData = var_98.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
