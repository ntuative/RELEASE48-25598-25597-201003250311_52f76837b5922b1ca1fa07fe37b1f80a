package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_920:MeMenuSettingsView;
      
      private var var_2362:int;
      
      private var var_566:BitmapData;
      
      private var var_993:Number = 1;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_920.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return int(var_1472 * (Number(param1 - var_677) / (var_993 - var_677)));
      }
      ...
      {
         return param1 / var_1472 * (var_993 - var_677) + var_677;
      }
   }
}
