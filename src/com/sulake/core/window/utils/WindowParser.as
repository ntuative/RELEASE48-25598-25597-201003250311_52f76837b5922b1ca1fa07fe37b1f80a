package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1502:String = "_TEMP";
      ...
      protected var var_1374:Map;
      
      protected var var_14:IWindowContext;
      
      protected var var_1375:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1375 = new Dictionary();
         ParamCodeTable.fillTables(var_932,var_1375);
         var_1374 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1375)
            {
               delete var_1375[_loc1_];
            }
            var_1374.dispose();
            var_1374 = null;
            var_14 = null;
