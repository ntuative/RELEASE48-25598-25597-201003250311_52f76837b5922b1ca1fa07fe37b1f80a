package com.sulake.habbo.messenger.domain
{
   ...
   public class ConversationsDeps implements IConversationsDeps
   {
      ...
      {
         var_140.messengerView.addMsgToView(param1,param2);
      }
      
      public function createConversation(param1:int) : Conversation
      {
         return var_140.createConversation(param1);
      }
      
      public function getText(param1:String) : String
      {
         return var_140.getText(param1);
      }
      
      public function getTabCount() : int
      {
         return var_140.messengerView.getTabCount();
      }
      
      public function refresh(param1:Boolean) : void
      {
         var_140.messengerView.refresh(param1);
      }
   }
}
