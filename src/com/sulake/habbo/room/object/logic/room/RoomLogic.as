package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1466:int = 1500;
      
      private var var_1464:int = 255;
      
      private var var_1465:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_689:
                  _loc2_.setString(RoomObjectVariableEnum.const_646,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_663:
                  _loc2_.setString(RoomObjectVariableEnum.const_570,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_501:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_450:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_229)
                  {
                     _loc8_ = "null";
                  }
                  var_412.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_502:
                  _loc7_ = var_412.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_412.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_874,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_969,int(_loc5_.bgOnly));
            var_1216 = _color;
            var_1464 = var_1145;
            var_984 = _loc11_;
            var_1465 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_74.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_793,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_587,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1335,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1260,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_144 || _loc13_ == RoomPlaneData.const_233)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_823)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_587,_loc3_);
         }
      }
   }
}
