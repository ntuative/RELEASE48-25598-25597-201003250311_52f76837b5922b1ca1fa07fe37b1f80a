package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_261[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_261.length)
               {
                  if((var_261[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_261[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_266 && false)
         {
