package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1090:String = AvatarSetType.const_37;
      
      private static const const_1089:String = "Default";
      
      private static const const_1088:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_395:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         var_395 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_395.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_1022;
         }
         var_122 = new AvatarImageCache(var_68,this,_assets,var_195);
         setDirection(const_1090,const_1087);
         var_196 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1247;
         if(param2 < AvatarDirectionAngle.const_1325)
         {
         ...
         if(var_659 == AvatarType.PET && param1 == AvatarSetType.const_47)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_68.sortActions(var_196);
         if(_loc1_ == null)
         {
            var_581 = new Array(0,0,0);
         }
         else
         {
            var_581 = var_68.getCanvasOffsets(_loc1_,var_195,var_90);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1247 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_509 = _loc3_.avatarData;
                  }
               }
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_385)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_68.getPartColor(var_395,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_68.getCanvas(var_195,var_172.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_68.getBodyParts(param1,var_172.definition,var_90);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_508);
            if(_loc10_ != null)
            {
               ...
               if(var_659 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_68.getParts(_loc9_,var_395,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_195 == AvatarScaleType.const_93)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_508);
                     _loc21_ = var_90;
                     _loc22_ = 1;
                     switch(var_90)
                     {
                     ...
                     _loc23_ = var_68.getPartActionOffset(getSubType(),var_195,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_68.getCanvas(var_195,var_172.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_68.getBodyParts(param1,var_172.definition,var_90);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_508);
            if(_loc8_ != null)
            {
               ...
               if(var_659 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_68.getParts(_loc7_,var_395,_loc12_,"pet",_loc11_.getDirection(),[]);
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_508);
                     _loc19_ = var_90;
                     _loc20_ = 1;
                     switch(var_90)
                     {
                     ...
                     _loc21_ = var_68.getPartActionOffset(getSubType(),var_195,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_509 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_509.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_172 = new ActiveActionData(AvatarAction.const_883);
         var_172.definition = var_68.getActionDefinition(const_1089);
      ...
      {
         return var_68.getBodyPartData(param1.animation.id,var_508,param1.id);
      }
            ...
            case AvatarAction.const_576:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1386:
                     if(var_659 == AvatarType.const_75)
                     {
                        if(var_90 == 0)
                        {
