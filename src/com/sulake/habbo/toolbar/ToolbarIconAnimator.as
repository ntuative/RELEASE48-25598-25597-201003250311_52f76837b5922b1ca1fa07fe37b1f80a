package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1245 = param1.loop;
         if(param1.background != null)
         {
            var_846 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_845.push(new XML());
               var_844.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_844[var_50] = param6.clone();
         }
      ...
      {
         if(var_1245 == true || var_699 == 0)
         {
            if(false)
            {
               ++var_50;
               if(var_50 >= var_845.length)
               {
                  var_50 = 0;
                  ++var_699;
               }
      ...
      {
         return var_845.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1245 == false && var_699 == 1 && var_1293 != var_31;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_846 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_846.width),Math.max(param2.height,var_846.height));
            _loc3_.copyPixels(var_846,var_846.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_50 <= var_844.length)
         {
            _loc2_ = var_844[var_50];
