package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_588:String = "InitConnection";
      ...
      private var var_353:HabboCommunicationDemo;
      ...
      {
         var_353.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_353.shockwaveClientUrl = var_111.shockwaveClientUrl;
         var_353.ssoTicket = var_111.ticket;
         var_111.removeEventListener(SSOTicket.const_314,onParsedTicketSuccess);
         var_111.removeEventListener(SSOTicket.const_239,onParsedTicketFailure);
         var_111 = null;
         dispatchEvent(new Event(const_588));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1416,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_353 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_353.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_460,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_353.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1416,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_353.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_353.habboCommunication.habboWebLogin(name,password);
         var_111 = new SSOTicket(var_353.assets,_loc2_,_loc1_);
         var_111.addEventListener(SSOTicket.const_314,onParsedTicketSuccess);
