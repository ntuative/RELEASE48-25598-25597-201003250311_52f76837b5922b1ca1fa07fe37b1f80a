package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1402:IIssueBrowserView;
      
      private const const_1625:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1626:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1403:IIssueBrowserView;
      ...
      private var var_1404:PickedIssuesView;
      
      private var var_329:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_215 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_215.numTabItems)
            {
               _loc5_ = var_215.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,onTabSelected);
               _loc6_++;
            }
         }
         var_215 = _window.findChildByName("tab_context") as ITabContextWindow;
         ...
         var _loc1_:ISelectableWindow = var_215.selector.getSelectableByName("open_issues");
         var_215.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_329.view.width = var_215.container.width;
         var_329.view.height = var_215.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1624:
               if(var_1403 == null)
               {
                  var_1403 = new MyIssuesView(issueManager,this,var_215.container);
               }
               return var_1403;
            case const_1625:
               if(var_1402 == null)
               {
                  var_1402 = new OpenIssuesView(issueManager,this,var_215.container);
               }
               return var_1402;
            case const_1626:
               if(var_1404 == null)
               {
                  var_1404 = new PickedIssuesView(issueManager,this,var_215.container);
               }
               return var_1404;
            default:
               return null;
