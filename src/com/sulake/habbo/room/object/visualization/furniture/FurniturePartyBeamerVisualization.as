package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_347:int = 2;
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_946 = new Array();
         var_946.push(Math.random() * _loc2_ * 1.5);
         var_946.push(Math.random() * _loc2_ * 1.5);
         var_947 = new Array();
         var_947.push(1);
         var_947.push(-1);
         var_948 = new Array();
         var_948.push(const_1028);
         var_948.push(const_1029);
         var_945 = new Array();
