package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_409:UserInfoCtrl;
      
      private var var_55:ModerationManager;
      
      private var var_1007:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.releaseBundle(var_109.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_409 = new UserInfoCtrl(_window,var_55,_loc3_.message);
         var_1007 = new UserInfoCtrl(_window,var_55,_loc3_.message);
         var_409.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_109.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1007.load(_loc4_,var_109.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.closeBundle(var_109.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_55,WindowTracker.const_810,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_55 != null && false && var_109 != null)
         {
            var_55.issueManager.removeHandler(var_109.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_409 = new UserInfoCtrl(_window,var_55,_loc3_.message);
            var_409.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.closeBundle(var_109.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.closeBundle(var_109.id,3);
         checkAutoHandling();
         dispose();
      }
