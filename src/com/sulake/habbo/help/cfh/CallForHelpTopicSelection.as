package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_682 == null || _loc3_ < 0 || _loc3_ >= var_682.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_682[_loc3_];
            main.showUI(HabboHelpViewEnum.const_550);
            main.tellUI(HabboHelpViewEnum.const_550,null);
         }
      }
   }
}
