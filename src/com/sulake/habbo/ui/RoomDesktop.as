package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1172:Boolean = true;
      ...
      private var var_834:IHabboHelp = null;
      ...
      private var var_1751:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_384,onRoomContentLoaded);
      ...
      {
         var_185 = param1;
         var_185.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         ...
         {
            var_656 = _roomEngine.loadRoomResources(var_36.roomResources);
            if(false)
            {
               var_1172 = false;
         ...
         if(var_256 != null && true)
         {
            var_1173 = !var_256.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_36.roomId,var_36.roomCategory,var_248[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_186 != null)
         {
            ...
            {
               _loc5_ = var_186.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_384,onRoomContentLoaded);
         ...
         if(var_185 && false)
         {
            var_185.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            var_185.events.removeEventListener(HabboToolbarEvent.const_54,onHabboToolbarEvent);
         }
         var_185 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1751);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_186.length)
         {
            _loc2_ = var_186.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_185 != null)
         {
            var_167.toolbarSize = var_185.size;
            var_167.toolbarOrientation = var_185.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_528:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_295,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_680 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_36.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_365)
                  {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_186.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_630);
            _loc13_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_609);
            _loc14_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_564);
            _loc15_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_682);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_36 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     var_185.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_440:
               ...
               var_166 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_332,WindowStyle.const_317,WindowParam.const_88) as IToolTipWindow;
               var_166.setParamFlag(WindowParam.const_50,false);
      ...
      {
         if(var_656 == null || false)
         {
            return;
         }
         var _loc2_:int = var_656.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_656.splice(_loc2_,1);
         }
         if(false)
         {
            var_1172 = true;
      ...
      {
         if(var_18 != null && var_36 != null && var_1173 && var_1172)
         {
            var_18.startSession(var_36);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_235));
         }
      }
