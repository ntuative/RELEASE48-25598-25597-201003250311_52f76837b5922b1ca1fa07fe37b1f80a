package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_962:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1729:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1420 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1729.append(var_1420);
         dispatchEvent(new Event(AvatarStructureDownload.const_962));
      }
   }
}
