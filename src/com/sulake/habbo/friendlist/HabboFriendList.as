package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1389:OpenedToWebPopup;
      
      private var var_765:IAvatarRenderManager;
      ...
      private var var_1388:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_764:FriendRequests;
      
      private var var_1612:int;
      
      var var_87:FriendCategories;
      
      private var var_1611:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_766:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1611 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_87 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1388 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_764.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_764.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_443.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_764 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.method_16);
         for each(_loc3_ in _loc2_.categories)
         {
            var_87.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_87.addCategory(new FriendCategory(FriendCategory.const_920,getText("friendlist.friends")));
         var_87.addCategory(new FriendCategory(FriendCategory.const_469,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_87.addFriend(new Friend(_loc4_));
         }
         var_443 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_452)
         {
            var_452 = new Timer(120000);
            var_452.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_452.start();
         }
         getBuddyRequests();
         registerListeners();
         var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_452.stop();
            var_452.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_452 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_140)
         {
            var_140.release(new IIDHabboMessenger());
            var_140 = null;
         }
         if(var_144)
         {
         ...
         if(var_765)
         {
            var_765.release(new IIDAvatarRenderManager());
            var_765 = null;
         }
         if(var_766)
         {
            var_766.release(new IIDHabboNotifications());
            var_766 = null;
         }
         if(var_185)
         {
      ...
      {
         var _loc1_:String = var_144.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_443.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         var_185 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1388.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_764.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_185.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_443.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_765.createAvatarImage(param1,AvatarScaleType.const_93);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_764.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_443.findTab(FriendListTab.const_87);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_765 = param2 as IAvatarRenderManager;
      ...
      {
         var_766 = param2 as IHabboNotifications;
      ...
      {
         return var_144.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1389 == null)
         {
            var_1389 = new OpenedToWebPopup(this);
         }
         var_1389.show(x,y);
      }
