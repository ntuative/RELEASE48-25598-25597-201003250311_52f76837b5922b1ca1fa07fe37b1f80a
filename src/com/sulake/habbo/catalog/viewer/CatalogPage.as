package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1389:String = "ctlg_";
      ...
      private var var_1124:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_879:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1389 + param1;
         ...
         var_1372 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1372) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_772);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1124;
            _loc2_.init();
         }
         var_1124.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1124.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_772);
      }
