package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1027:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_145.state = RoomChatHistoryPulldown.const_215;
         ...
         var_40 = param2.createWindow("chatscroller","",HabboWindowType.const_803,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_213 > 0 && param2)
         {
            if(var_1117)
            {
               if(Math.abs(param1 - var_213) <= const_971)
               {
                  return;
               }
               var_1117 = false;
            ...
            if(var_289)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_40.scrollV < 1 - const_1027 / var_40.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1393)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_289 && !var_1236)
         {
            ...
            var_145.state = RoomChatHistoryPulldown.const_287;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_145.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_215);
      }
