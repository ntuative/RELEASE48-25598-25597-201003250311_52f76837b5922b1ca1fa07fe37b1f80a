package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1619 = this._navigator.getButtonImage(this.var_1620);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1622 == null)
         {
            ...
            this.var_1622 = new Rectangle(var_1392,var_1392,_loc1_.width - 2 * var_1392,_loc1_.height - 2 * var_1392);
         }
         var_637.bitmap.fillRect(var_637.bitmap.rect,4281545523);
         var_637.bitmap.fillRect(this.var_1622,4284900966);
         copyTo(var_637.bitmap);
         if(_selected)
         {
            var_637.bitmap.copyPixels(var_1621,var_1621.rect,new Point(0,0),null,null,true);
         }
         var_637.invalidate();
      }
