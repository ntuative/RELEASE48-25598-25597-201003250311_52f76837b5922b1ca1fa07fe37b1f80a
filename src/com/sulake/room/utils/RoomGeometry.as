package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_662:Number = 64;
      
      public static const const_925:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_84 = new Vector3d();
         var_1029 = new Vector3d();
         var_1496 = 1;
         var_1494 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1495 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public static function method_14(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d) : IVector3d
      {
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_230.assign(param1);
         if(var_230.x != _loc2_ || var_230.y != _loc3_ || var_230.z != _loc4_)
         {
            ++var_75;
         }
      ...
      {
         if(var_415 != param1 * var_1495)
         {
            var_415 = param1 * var_1495;
            ++var_75;
         }
      }
      ...
      {
         if(var_416 != param1 * var_1496)
         {
            var_416 = param1 * var_1496;
            ++var_75;
         }
      }
      ...
      {
         if(var_413 != param1 * var_1494)
         {
            var_413 = param1 * var_1494;
            ++var_75;
         }
      }
      ...
      {
         return new Vector3d(var_230.x,var_230.y,var_230.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1029.assign(_loc22_);
         }
         else
         {
            var_1029.assign(_loc17_);
         }
         ++var_75;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_413;
         _loc2_.z *= var_415;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1029);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_413;
            _loc2_.z *= var_415;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1029);
         }
      ...
      {
         return new Vector3d(0 * var_416,0 * var_413,0 * var_415);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_416,0 * var_413,0 * var_415);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_416,param2.y * var_413,param2.z * var_415);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_416,param3.y * var_413,param3.z * var_415);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_416,param4.y * var_413,param4.z * var_415);
         var _loc14_:IVector3d = Vector3d.crossProduct(_loc12_,_loc13_);
         var _loc15_:Vector3d = RoomGeometry.method_14(_loc9_,_loc10_,_loc11_,_loc14_) as Vector3d;
         if(_loc15_ != null)
         {
            _loc15_.sub(_loc11_);
