   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_185 + " " + _loc6_);
            if(var_185 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_915,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_185.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_921,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_866,onHabboClubSubscriptionChanged);
         }
         var_185 = _container.toolbar;
         if(var_185)
         {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_445:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_417));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_516);
         _loc1_.push(RoomWidgetDanceMessage.const_602);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_548);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_555);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_711);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_667);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_657);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_514);
         _loc1_.push(RoomWidgetStopEffectMessage.const_626);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1165);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_884);
         _loc1_.push(RoomWidgetToolbarMessage.const_647);
         _loc1_.push(RoomWidgetToolbarMessage.const_508);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_524);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1183);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_968);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_545);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_707);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_515);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1264);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_691);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_736);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_718);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_707:
               ...
               break;
            case RoomWidgetWaveMessage.const_516:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_602:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_548:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_555:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_711:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_514:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_801)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_258,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_657:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_983:
                        _catalog.openCatalogPage(CatalogPageName.const_1173,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_808:
                        var_10.toggleInventoryPage(InventoryCategory.const_266);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1368:
                        var_10.toggleInventoryPage(InventoryCategory.const_72);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1314:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_667:
            case RoomWidgetStopEffectMessage.const_626:
            ...
            case RoomWidgetNavigateToRoomMessage.const_884:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_545:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_647:
               ...
               if(var_185)
               {
                  var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_508:
               ...
               if(var_185 && false)
               {
                  var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_395,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_524:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_604));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_515:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_691:
            ...
            case RoomWidgetStoreSettingsMessage.const_736:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_286,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_718:
               if(false && _container.habboHelp.events)
               {
