package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2253:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25598-25597-201003250241");
         var_185 = param5;
         var_103 = new Map();
         var_103.add(HabboHelpViewEnum.const_1291,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_139,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_447,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_244,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_194,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_671,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_312,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_550,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_224,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_103.add(HabboHelpViewEnum.const_941,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_103.add(HabboHelpViewEnum.const_654,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1595 = 0 - _loc3_.width;
         var_1594 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_285 == HabboHelpViewEnum.const_139 || false)
         {
            return;
         }
         if(var_444 == null)
      ...
      {
         return var_103.getValue(var_285);
      }
      ...
      {
         var_2254 = param1;
         var _loc2_:IHelpViewController = var_103.getValue(HabboHelpViewEnum.const_139) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1012:
               showUI(HabboHelpViewEnum.const_941);
               break;
            case CallForHelpResultEnum.const_910:
      ...
      {
         var _loc3_:* = null;
         if(var_285 == HabboHelpViewEnum.const_139)
         {
            return;
         }
         if(true)
         {
            ...
            var_622.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_622[1],var_622[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_622[0],var_622[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1594;
         _window.width = _loc1_.width + var_1595;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_185 != null)
            {
               var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_712));
      }
