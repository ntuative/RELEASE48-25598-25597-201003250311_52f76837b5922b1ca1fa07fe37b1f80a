package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1268));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1499[var_1268]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_262.width,var_262.height);
         var_262.x = _loc2_.x;
         var_262.y = _loc2_.y;
         var_1499[var_1268] = var_262;
      }
   }
}
