package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_615 = _main.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_615.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU_ARROW,var_615));
      }
