package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_762:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1474)
         {
            case RecyclerStatusMessageEvent.const_1212:
               var_252 = const_343;
               if(_view == null)
               {
                  return;
      ...
      {
         return var_1474 != RecyclerStatusMessageEvent.const_940;
      }
      
      private function get statusActive() : Boolean
      {
         return var_252 != const_762;
      }
      ...
      {
         return active && var_252 == const_343;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_987:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1215:
