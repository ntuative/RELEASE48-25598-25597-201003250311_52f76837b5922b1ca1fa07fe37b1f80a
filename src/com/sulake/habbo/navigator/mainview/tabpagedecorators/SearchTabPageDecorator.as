package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1395:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_196,"-1",MainViewCtrl.const_622);
      }
      ...
      private function method_4(param1:String) : String
      {
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_301)
            {
               _navigator.registerParameter("navigator.tagsearchresults","room_count","" + _navigator.data.guestRoomSearchResults.rooms.length);
               _navigator.registerParameter("navigator.tagsearchresults","tag_name",method_4(_navigator.data.guestRoomSearchResults.searchParam));
               _loc4_.visible = true;
            }
            else
            {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1395 == null)
         {
            ...
            var_1395 = new TextSearchInputs(_navigator,false,_loc4_);
            initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(_navigator.data.guestRoomSearchArrived && _navigator.data.guestRoomSearchResults.searchType == Tabs.const_196)
         {
            var_1395.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
