package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_663 >= 0 && var_169.length > var_663)
         {
            _loc2_ = var_169[var_663];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_222[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_222.length <= param1)
         {
            return null;
         }
         return var_222[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_169[var_663] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_222)
         {
            for each(_loc2_ in var_222 as Array)
            {
               if(_loc2_)
               {
