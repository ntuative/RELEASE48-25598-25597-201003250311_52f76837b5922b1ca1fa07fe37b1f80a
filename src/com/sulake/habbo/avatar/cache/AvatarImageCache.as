package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1410:int = 60000;
      ...
      private var var_916:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_362)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_68.getParts(param1,(var_916 as AvatarImage).getFigure(),_loc6_,var_1221,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_68.getCanvas(var_195,var_1221);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1213[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_840 || _loc32_ == AvatarAction.const_562) && (_loc6_ == AvatarBodyPartType.const_296 || _loc6_ == AvatarBodyPartType.const_1344 || _loc6_ == AvatarBodyPartType.const_1250) && _loc7_.color != null)
               {
