package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_238,Tabs.const_306);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_238,Tabs.const_668);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_238,Tabs.const_306,"" + _loc3_);
         }
      }
