package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_725);
         _loc2_.refreshViews();
         var_10.notifyChangedEffects();
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_10.setInventoryCategoryInit(InventoryCategory.const_285);
      }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_10.setInventoryCategoryInit(InventoryCategory.const_266);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_468);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
