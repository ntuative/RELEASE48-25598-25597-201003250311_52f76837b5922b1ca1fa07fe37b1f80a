package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_203[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1483)
         {
            _loc4_ = param1 / var_430;
            param1 %= var_430;
            if(var_1551 > 0 && _loc4_ >= var_1551)
            {
               param1 = var_430 - 1;
               _loc3_ = true;
            }
            ...
            {
               _loc2_ = var_203[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_203[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_203.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_203[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
