package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1214 || var_1432 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1431 == 0 || _loc1_ - var_1431 > var_1432)
         {
            if(_connection != null)
            {
      ...
      {
         var_1214 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1432 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
