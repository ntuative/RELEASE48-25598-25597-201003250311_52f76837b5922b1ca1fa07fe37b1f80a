package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2265:BitmapData;
      
      protected var var_933:Boolean;
      ...
      protected var var_368:BitmapData;
      
      private const const_1405:Number = 0.2;
      
      protected var var_1376:Boolean;
      
      private const const_1404:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_696)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1404;
               _loc1_.blend = const_1404;
            }
         }
         if(isSelected)
         {
