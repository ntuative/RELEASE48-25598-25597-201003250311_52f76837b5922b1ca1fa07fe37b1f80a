package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_400,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_400,onObjectUpdate);
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_607,var_149);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1061,const_1064,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_191 != null)
         {
            _loc4_.caption = var_191;
         }
