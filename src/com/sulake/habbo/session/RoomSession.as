package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_978:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_303 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_96;
            if(isPrivateRoom)
            {
      ...
      {
         return var_978 as IUserDataManager;
      }
