package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1479);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_686)
         {
            return;
         }
         if(var_686 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_686) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_686 % 2) ? uint(const_1412) : uint(const_1411);
            }
         }
