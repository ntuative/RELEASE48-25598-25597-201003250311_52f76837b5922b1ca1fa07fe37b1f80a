package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_200 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_959,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1063 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1063)
         {
         ...
         var_1310 = _loc7_.toolbar.@margin_bottom;
         var_1533 = _loc7_.toolbar.@min_group_margin;
         var_1534 = _loc7_.toolbar.@margin_to_extrabar;
         var_265 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_271,param1,param2,_window,var_265);
         createGroupsFromXmlList(_loc9_,var_598,param1,param2,var_200,var_265);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_134,var_518,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1533,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1310) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1533,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1310) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_134,var_518);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_518);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_134,var_518);
         }
      }
