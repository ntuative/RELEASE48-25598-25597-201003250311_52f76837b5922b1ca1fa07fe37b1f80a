package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1020 != null)
         {
            var_1020.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1021 != null)
         {
            var_1021.removeEventListener(WindowKeyboardEvent.const_135,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1020 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1020 != null)
         {
            var_1020.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1021 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1021 != null)
         {
            var_1021.addEventListener(WindowKeyboardEvent.const_135,windowKeyEventProcessor);
         }
      }
