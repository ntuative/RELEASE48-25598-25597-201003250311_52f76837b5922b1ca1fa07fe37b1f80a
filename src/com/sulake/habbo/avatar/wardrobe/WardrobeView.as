package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_694:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1013:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_694 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1013 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_694)
         {
            var_694.removeListItems();
         }
         if(var_1013)
         {
            var_1013.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_694)
               {
                  var_694.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1013)
            {
               var_1013.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
