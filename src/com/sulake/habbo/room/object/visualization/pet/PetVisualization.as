package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_777:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_821);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_899)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_886);
               var_454 = const_1031;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_237);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_287 != _loc3_.getUpdateID() || var_207 != param1.scale || var_158 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_454 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            increaseUpdateId();
            _loc18_ = getTimer();
            ...
            if(var_395 != _loc7_)
            {
               for each(_loc36_ in var_398.getKeys())
               {
                  var_398.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_288);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_237);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_724);
            _loc6_.appendAction(AvatarAction.const_576,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_419);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_407);
               _loc39_ = 3;
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_432) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1030;
            ...
            _loc31_ = getSprite(const_1628);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_777.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_778.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_778)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_777 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
